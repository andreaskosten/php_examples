...
class ImageSaver
{
    ...
    public function __construct($sizeLimit, $widthLimit, $heightLimit)
    {
     ...
     * @return bool
     */
    public function saveImage($files): bool
    {
     ...
     * @return string
     */
    private function generateRandomName($limit): string
    {
        $now = date('md-His');
     ...
     * @return string
     */
    private function getFormat($num): string
    {
        if ($num === 2) { return 'jpg'; }
        if ($num === 3) { return 'png'; }
        return false;
     ...
     * @param string $text
     */
    private function handleError($text): void
    {
